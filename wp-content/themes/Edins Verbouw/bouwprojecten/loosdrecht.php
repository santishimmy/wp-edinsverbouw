...
<?php /* Template Name: Loosdrecht */ ?>

<html lang="nl">
    <head>
        <title>Edin's Verbouw & Renovatie</title>
        <!-- Meta Tags (SEO and all that) -->
        <meta name="description" content="<?php the_field('field_60e2d2b96be86') ?>">
        <meta name="keywords" content="<?php the_field('field_60e2d2b96818f') ?>">

        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="cache-control" content="public">
        <link rel="cannonical" href="https://edinsverbouw.nl/projecten/loosdrecht">
    ...
    <body>
        ...
        <div class="blue-ish-background small-section">
            <div class="section-title">
                <h1><?php the_field('field_60e2d2b93489f') ?></h1>
                <h2><?php the_field('field_60e2d2b9383a0') ?></h2>
            </div>
        </div>
        ...
        <div id="away-with-the-padding-bottom" class="grey-ish-background section">
            <div class="carousel carousel-main" data-flickity>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b943649') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b9470f1') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b94ab6a') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b94e5a7') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b952064') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b9559c0') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b959339') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b95cfc5') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b960aa0') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d2b9646e8') ?>">
                    <span class="overlay-cell"></span>
                </div>
            </div>
