...
<?php /* Template Name: Hilversum */ ?>

<html lang="nl">
    <head>
        <title>Edin's Verbouw & Renovatie</title>
        <!-- Meta Tags (SEO and all that) -->
        <meta name="description" content="<?php the_field('field_60e2d7a6df680') ?>">
        <meta name="keywords" content="<?php the_field('field_60e2d7a6dbad2') ?>">

        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="cache-control" content="public">
        <link rel="cannonical" href="https://edinsverbouw.nl/projecten/hilversum">
    ...
    <body>
        ...
        <div class="blue-ish-background small-section">
            <div class="section-title">
                <h1><?php the_field('field_60e2d7a6a81da') ?></h1>
                <h2><?php the_field('field_60e2d7a6abe50') ?></h2>
            </div>
        </div>
        ...
        <div id="away-with-the-padding-bottom" class="grey-ish-background section">
            <div class="carousel carousel-main" data-flickity>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6b6e09') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6ba81f') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6be173') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6c1ac5') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6c5693') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6c9314') ?>">
                    <span class="overlay-cell"></span>
                </div>
				<?php /*
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6ccd9e') ?>">
                    <span class="overlay-cell"></span>
                </div>*/?>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6d086e') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6d431c') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d7a6d7ff8') ?>">
                    <span class="overlay-cell"></span>
                </div>
            </div>
