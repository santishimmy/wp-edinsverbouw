...
<?php /* Template Name: Kortenhoef */ ?>

<html lang="nl">
    <head>
        <title>Edin's Verbouw & Renovatie</title>
        <!-- Meta Tags (SEO and all that) -->
        <meta name="description" content="<?php the_field('field_60e2d6e1d729d') ?>">
        <meta name="keywords" content="<?php the_field('field_60e2d6e1d3804') ?>">

        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="cache-control" content="public">
        <link rel="cannonical" href="https://edinsverbouw.nl/projecten/kortenhoef">
    ...
    <body>
        ...
        <div class="blue-ish-background small-section">
            <div class="section-title">
                <h1><?php the_field('field_60e2d6e1a0207') ?></h1>
                <h2><?php the_field('field_60e2d6e1a3c99') ?></h2>
            </div>
        </div>
        ...
        <div id="away-with-the-padding-bottom" class="grey-ish-background section">
            <div class="carousel carousel-main" data-flickity>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1aee13') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1b28bd') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1b633f') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1b9dff') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1bd88e') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1c1329') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1c4daa') ?>">
                    <span class="overlay-cell"></span>
                </div>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1c884b') ?>">
                    <span class="overlay-cell"></span>
                </div>
				<?php /*
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1cc2d0') ?>">
                    <span class="overlay-cell"></span>
                </div>*/?>
                <div class="carousel-cell">
                    <img src="<?php the_field('field_60e2d6e1cfd6c') ?>">
                    <span class="overlay-cell"></span>
                </div>
            </div>
